...
![ST-LINK/V2](images/01stlink.jpg)
...
![ST-LINK/V2 Mini](images/07mini.jpg)
...
![Particle Programmer Shield](images/08shield.jpg)
...
![ST-LINK Connect](images/02connect.png)
...
![ST-LINK Program](images/03program.png)
...
![ST-LINK Save Config](images/04saveconfig.png)
...
![ST-LINK Restore Config](images/05restoreconfig.png)
...
![ST-LINK Erase Config](images/06eraseconfig.png)
...
If you are using the Particle Programmer shield you will also need to install the board file for it. Download the file particle-ftdi.cfg and put it in your install location, typically:
